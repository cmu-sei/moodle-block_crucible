...
$string['orgrolesyncmappingconflictdesc'] = 'These OAuth 2 issuer field mappings write profile fields that the Crucible user sync owns. Login stores the raw value from the token, which overwrites the delimiter-wrapped form the cohort conditions match on, so organization roles stop being granted. Remove these mappings under Site administration &gt; Server &gt; OAuth 2 services, and let the sync task maintain the fields.';
