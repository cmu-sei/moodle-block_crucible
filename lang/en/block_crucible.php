...
$string['configsuspendmissingusers'] = 'When enabled, a user who is deleted or disabled in Keycloak is suspended in Moodle. Their organization roles are taken back either way; this setting only decides whether the account itself is left usable.';
