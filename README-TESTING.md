# Testing block_crucible Locally

## Prerequisites

```bash
cd /mnt/data/crucible/moodle/blocks/crucible
composer install
```
...
# Check specific file
vendor/bin/phpcs --standard=moodle block_crucible.php
...
```bash
vendor/bin/phpcbf --standard=moodle --dry-run .
```
